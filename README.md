### ¡Hola, soy Jonathan Huenuanca! 👋 | a.k.a. @JAHP07
...
- 🎓 Titulado en **Ingeniería en Informática** — INACAP (2021-2025)
- 🏦 Experiencia en el sector financiero: ETL, esquemas estrella y automatización con Python + Power Automate
- 🧠 Proyecto de título: pipeline de datos end-to-end con Machine Learning (clasificación de pacientes + API REST en Django)
- 🌋 Analizo datos de sismos chilenos: tengo un [proyecto público de análisis sísmico](https://github.com/JAHP07/An-lisis-Exploratorio-y-Modelado-Predictivo-de-Datos-S-smicos-en-Chile)
- 📚 Autodidacta y en constante aprendizaje: profundizando en PySpark, dbt y cloud (AWS)
...
![Power BI](https://img.shields.io/badge/POWER_BI-222222?style=for-the-badge&logo=powerbi&logoColor=F2C811)
...
- 🌋 [Proyecto: Análisis Exploratorio y Modelado Predictivo de Datos Sísmicos en Chile](https://github.com/JAHP07/An-lisis-Exploratorio-y-Modelado-Predictivo-de-Datos-S-smicos-en-Chile)